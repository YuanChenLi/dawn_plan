...
var db = mongoose.createConnection('mongodb://127.0.0.1:27017/NodeJS', options);
// 链接错误
...
mongooseSchema.methods.findbyusername = function(username, callback) {
    return this.model('mongoose1').find({username: username}, callback);
}
// 添加 mongoose 静态方法，静态方法在Model层就能使用
mongooseSchema.statics.findbytitle = function(title, callback) {
    return this.model('mongoose1').find({title: title}, callback);
}
// model
var mongooseModel = db.model('mongoose1', mongooseSchema);
// 增加记录 基于 entity 操作
